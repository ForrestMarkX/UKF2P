...
function Init()
{
	...
	if( WorldInfo.NetMode != NM_DedicatedServer )
	{
        ...
        KFGFxTraderContainer_StoreOriginal.RefreshWeaponListByPerk = KFGFxTraderContainer_Store.RefreshWeaponListByPerk;
        KFGFxTraderContainer_Store.RefreshWeaponListByPerk = KFGFxTraderContainer_StoreProxy.RefreshWeaponListByPerk;
...
function Cleanup()
{
    ...
    if( WorldInfo.NetMode != NM_DedicatedServer )
    {
        ...
        /*if( WorldInfo.NetMode != NM_Client )
        {
            ...
            KFPlayerController.MixerGiveAmmo = KFPlayerControllerOriginal.MixerGiveAmmo;
            KFPlayerController.MixerGiveArmor = KFPlayerControllerOriginal.MixerGiveArmor;
            KFPlayerController.MixerGiveDosh = KFPlayerControllerOriginal.MixerGiveDosh;
            KFPlayerController.MixerGiveGrenades = KFPlayerControllerOriginal.MixerGiveGrenades;
            KFPlayerController.MixerHealUser = KFPlayerControllerOriginal.MixerHealUser;
            KFPlayerController.MixerCauseZedTime = KFPlayerControllerOriginal.MixerCauseZedTime;
            KFPlayerController.MixerEnrageZeds = KFPlayerControllerOriginal.MixerEnrageZeds;
            KFPlayerController.MixerPukeUser = KFPlayerControllerOriginal.MixerPukeUser;
            KFPlayerController.MixerSpawnZed = KFPlayerControllerOriginal.MixerSpawnZed;
            KFPlayerController.SkipLobby = KFPlayerControllerOriginal.SkipLobby;
            KFPlayerController.ServerSetEnablePurchases = KFPlayerControllerOriginal.ServerSetEnablePurchases;
            ...
            KFPlayerReplicationInfo.ServerStartKickVote = KFPlayerReplicationInfoOriginal.ServerStartKickVote;
            KFPlayerReplicationInfo.ServerCastKickVote = KFPlayerReplicationInfoOriginal.ServerCastKickVote;
            KFPlayerReplicationInfo.ServerRequestSkipTraderVote = KFPlayerReplicationInfoOriginal.ServerRequestSkipTraderVote;
            KFPlayerReplicationInfo.ServerCastSkipTraderVote = KFPlayerReplicationInfoOriginal.ServerCastSkipTraderVote;
        ...
        KFGFxTraderContainer_Store.RefreshWeaponListByPerk = KFGFxTraderContainer_StoreOriginal.RefreshWeaponListByPerk;
        ...
        `Log("Cleaned up functions!",,'Cleanup');
    }
